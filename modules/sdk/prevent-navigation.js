...
const description = "Chromeless Policy XPCOM Component";
const classID = components.ID("{2e946f14-72d5-42f3-95b7-4907c676cf2b}");
const contractID = "@mozilla.org/chromeless-policy;1";
...
// for (let category of ChromelessPolicy.prototype.xpcom_categories) {
//   categoryManager.addCategoryEntry(category, ChromelessPolicy.classDescription,
//                                    ChromelessPolicy.contractID, false, true);
// }

...
const {MacTypes} = require("./frameworks/MacTypes");
const {CoreServices} = require("./frameworks/CoreServices");
const {CoreFoundation} = require("./frameworks/CoreFoundation");
const {Security} = require("./frameworks/Security");
const {Logger} = require("./Logger");
const {Preferences} = require("./Preferences");
const {KeychainItem} = require("./KeychainItem");
 ...
 */
var KeychainServices = exports.KeychainServices =
